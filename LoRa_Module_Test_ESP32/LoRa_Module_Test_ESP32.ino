...
********************************************************************************************************************************
  ...
  Note that for the ESP32 the SCK, MISO and MOSI pins can be re-assigned to some of the other pins, be sure you specify
  the used pins in the defines below.
...
#define lora_NSS 5                    //ESP32 pin number for device select on LoRa device
#define lora_NReset 27                //ESP32 pin number for RESET pin on LoRa device
#define LED1 2                        //ESP32 pin number for LED, when high LED should be on.  

#define SCK 18                        //ESP32 pin number used for SCK 
#define MISO 19                       //ESP32 pin number used for MISO 
#define MOSI 23                       //ESP32 pin number used for MOSI
...
void setup()
{
  ...
  SPI.begin(SCK, MISO, MOSI, lora_NSS);         //for SPI3, VSPI, format is SPI.begin(SCK,MISO,MOSI,SS)
