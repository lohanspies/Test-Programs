...
*******************************************************************************************************************************
  ...
  Copyright of the author Stuart Robinson - 31/12/17
  ...
  This is program is the routines for using the LoRa device as a signal generator
...
const byte lora_RXBUFF_Size = 128;  //Receiver buffer                         
const byte lora_TXBUFF_Size = 128;  //Transmit buffer
