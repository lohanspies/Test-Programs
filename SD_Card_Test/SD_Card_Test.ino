...
The testfile is part of the source code for the Apollo 11 Lunar Lander navigation and guidance computer. There are 5 LED flashes 
at the power up and reset, then at start of every loop of the test. The LED is on whilst the testfile is being read. If the LED flashes very rapidly then 
there is a problem reading the test file/
********************************************************************************************************************************
*/
...
The program uses the hardware SPI interface on the Arduino to connect to the SD card module, so the SPI SCK, MOSI and MISO pins are
...
//#define SD_CS                        //Arduino pin number for device select on SD card module
